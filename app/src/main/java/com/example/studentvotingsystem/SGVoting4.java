...
public class SGVoting4 extends AppCompatActivity {
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgAssistantSecretary", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgAssistantSecretary", selectedCandidate);
            editor.apply();
            ...
            if (getIntent().hasExtra("fromSummary")) {
                ...
                Intent intent = new Intent(this, SGVoting5.class);
                startActivity(intent);
            }
            finish();
        } else {
    ...
    public void onBackPressed() {
        ...
        if (getIntent().hasExtra("fromSummary")) {
            ...
            Intent intent = new Intent(this, SGVoting3.class);
            startActivity(intent);
        }
        finish();
    }
