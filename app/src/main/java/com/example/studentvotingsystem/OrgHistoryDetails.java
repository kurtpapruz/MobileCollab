...
public class OrgHistoryDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_history_details);
    ...
    private void loadElectionDetails() {
        ...
        if (extras != null) {
            String title = extras.getString("election_title", "BITS Officer Election");
