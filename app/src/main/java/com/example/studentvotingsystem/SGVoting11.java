...
public class SGVoting11 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting11);
    ...
    private void moveToNextStep() {
        ...
        Intent intent = new Intent(this, SGVoting12.class);  // Navigate to next step
            ...
            switch (candidateIndex) {
                ...
                case 1:
                    dialog.setData(
                        ...
                        "BSIT",
                        "3rd Year",
                        "• Help manage financial transactions\n" +
                        "• Support business development\n" +
                        "• Assist in inventory management\n" +
                        "• Aid in financial reporting\n" +
                        "• Help maintain business records",
                        R.drawable.candidate_placeholder
                    );
                    dialog.show();
                    break;
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, SGVoting10.class);  // Changed to previous step
        startActivity(intent);
        finish();
    }
}