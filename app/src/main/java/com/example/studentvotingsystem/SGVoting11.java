...
public class SGVoting11 extends AppCompatActivity {
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgMultimediaHead", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgMultimediaHead", selectedCandidate);
            editor.apply();
            ...
            if (getIntent().hasExtra("fromSummary")) {
                ...
                Intent intent = new Intent(this, SGVoting12.class);
                startActivity(intent);
            }
            finish();
        } else {
    ...
    public void onBackPressed() {
        ...
        if (getIntent().hasExtra("fromSummary")) {
            ...
            Intent intent = new Intent(this, SGVoting10.class);
            startActivity(intent);
        }
        finish();
    }
