...
public class SGVoting14 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting14);
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgSecondYearRep", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgSecondYearRep", selectedCandidate);
            editor.apply();
