...
public class SGVoting9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting9);
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgBusinessManager", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgBusinessManager", selectedCandidate);
            editor.apply();
