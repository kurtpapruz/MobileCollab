...
public class SGVoting6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting6);
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgAssistantTreasurer", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgAssistantTreasurer", selectedCandidate);
            editor.apply();
            ...
            if (getIntent().hasExtra("fromSummary")) {
                ...
                Intent intent = new Intent(this, SGVoting7.class);
                startActivity(intent);
            }
            finish();
        } else {
