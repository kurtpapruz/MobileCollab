...
public class SGVoting10 extends AppCompatActivity {
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgAssistantBusinessManager", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgAssistantBusinessManager", selectedCandidate);
            editor.apply();
    ...
    public void onBackPressed() {
        ...
        if (getIntent().hasExtra("fromSummary")) {
            ...
            Intent intent = new Intent(this, SGVoting9.class);
            startActivity(intent);
        }
        finish();
    }
