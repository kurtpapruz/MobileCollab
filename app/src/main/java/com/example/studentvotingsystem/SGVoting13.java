...
public class SGVoting13 extends AppCompatActivity {
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgFirstYearRep", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgFirstYearRep", selectedCandidate);
            editor.apply();
            ...
            if (getIntent().hasExtra("fromSummary")) {
                ...
                Intent intent = new Intent(this, SGVoting14.class);
                startActivity(intent);
            }
            finish();
        } else {
