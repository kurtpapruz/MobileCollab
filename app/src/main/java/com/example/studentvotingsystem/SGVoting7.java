...
public class SGVoting7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting7);
    ...
    private void moveToNextStep() {
        ...
        editor.putString("sgAuditor", selectedCandidate);  // Key for auditor position
        editor.apply();

        // Navigate to the next voting step
        Intent intent = new Intent(this, SGVoting8.class);  // Navigate to next step
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, SGVoting6.class);  // Changed to previous step
        startActivity(intent);
        finish();
    }
}