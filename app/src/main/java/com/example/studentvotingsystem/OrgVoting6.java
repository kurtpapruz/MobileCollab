...
public class OrgVoting6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_voting6);
    ...
    private void moveToNextStep() {
        ...
        Intent intent = new Intent(this, OrgVoting7.class);
        startActivity(intent);
        finish();
        // Show confirmation dialog before proceeding to dashboard
    ...
    private void showConfirmationDialog() {
        ...
        builder.setTitle("Confirm Vote Submission")
                .setMessage("Are you sure you want to submit your votes? This action cannot be undone.")
                .setPositiveButton("Submit", (dialog, which) -> {
                    // TODO: Implement actual vote submission
                    Toast.makeText(this, "Votes submitted successfully!", Toast.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, OrgVoting5.class);
        startActivity(intent);
        finish();
    }
}