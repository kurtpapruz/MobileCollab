...
public class SGVoting12 extends AppCompatActivity {
    ...
    private void moveToNextStep() {
        ...
        Intent intent = new Intent(this, SGVoting13.class);  // Navigate to next step
            ...
            switch (candidateIndex) {
                ...
                case 1:
                    dialog.setData(
                        ...
                        "• Monitor event security\n" +
                        "• Coordinate with authorities\n" +
                        "• Manage emergency response\n" +
                        "• Ensure peaceful gatherings",
                        R.drawable.candidate_placeholder
                    );
                    dialog.show();
                    break;
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, SGVoting11.class);  // Changed to previous step
        startActivity(intent);
        finish();
    }
}