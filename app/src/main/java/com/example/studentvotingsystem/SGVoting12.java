...
public class SGVoting12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting12);
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgAssistantMultimediaHead", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgAssistantMultimediaHead", selectedCandidate);
            editor.apply();
            ...
            if (getIntent().hasExtra("fromSummary")) {
                ...
                Intent intent = new Intent(this, SGVoting13.class);
                startActivity(intent);
            }
            finish();
        } else {
    ...
    public void onBackPressed() {
        ...
        if (getIntent().hasExtra("fromSummary")) {
            ...
            Intent intent = new Intent(this, SGVoting11.class);
            startActivity(intent);
        }
        finish();
    }
