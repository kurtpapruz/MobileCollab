...
public class OrgVoting2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_voting2);
    ...
    private void moveToNextStep() {
        ...
        // Navigate to the organization voting step
        Intent intent = new Intent(this, OrgVoting3.class);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        // Navigate back to the President voting screen
