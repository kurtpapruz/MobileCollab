...
public class SGVoting15 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sgvoting15);
    ...
    private void loadExistingSelection() {
        ...
        String existingVote = prefs.getString("sgThirdYearRep", null);
    ...
    private void moveToNextStep() {
        ...
        if (selectedCandidate != null) {
            ...
            editor.putString("sgThirdYearRep", selectedCandidate);
            editor.apply();
