...
public class OrgVoting3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_org_voting3);
    ...
    private void moveToNextStep() {
        ...
        // Navigate to the next voting step (Review/Summary screen)
        Intent intent = new Intent(this, OrgVoting4.class);
    ...
    public void onBackPressed() {
        ...
        Intent intent = new Intent(this, OrgVoting2.class);
        startActivity(intent);
        finish();
    }
}